...
minetest.register_privilege("nuke", {
	description = "Can spawn nukes!",
	give_to_singleplayer = false
})

nuke.spawn_tnt = function(pos, entname, puncher)
	if minetest.check_player_privs(puncher:get_player_name(), "nuke") then
		...
		minetest.chat_send_player(puncher:get_player_name(), "You don't have the necessary privs!")
	end
end
